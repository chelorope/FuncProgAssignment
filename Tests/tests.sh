...
do
  ...
  echo "running $prog ..." >> awk-output1.ltxt
  awk "$prog" sample.ltxt >> awk-output1.ltxt


done
./awki "`cat ej1.awk`"  < sample.ltxt > awki-output1.ltxt
diff awk-output1.ltxt awki-output1.ltxt
